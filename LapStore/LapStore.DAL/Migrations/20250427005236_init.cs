        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecurityStamp = table.Column<string>(type: "nvarchar(100)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(100)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClaimType = table.Column<string>(type: "nvarchar(100)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderDisplayName = table.Column<string>(type: "nvarchar(100)", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_addresses_ZipCode_City_Governorate_Country",
                table: "addresses",
                columns: new[] { "ZipCode", "City", "Governorate", "Country" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_UserName_Email_PhoneNumber",
                table: "AspNetUsers",
                columns: new[] { "UserName", "Email", "PhoneNumber" },
                unique: true,
                filter: "[UserName] IS NOT NULL AND [Email] IS NOT NULL AND [PhoneNumber] IS NOT NULL");
